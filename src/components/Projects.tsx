  ...
  const projects = [
    {
      ...
      tags: ['Talent-as-a-Service', 'Platform', '10K+ Specialists'],
    ...
    },
    {
      ...
      tags: ['HealthTech', 'IoT', 'Real-time Monitoring'],
    ...
    },
    {
      ...
      tags: ['Microelectronics', 'B2B', 'Hardware'],
    ...
    },
    {
      ...
      tags: ['AI', 'Product Management', 'Stealth'],
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {projects.map((project, index) => (
              <Card
                key={index}
                className={`group hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-0 ${project.color} animate-fade-in`}
