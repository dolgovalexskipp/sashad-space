...
const translations = {
  ru: {
    ...
    'hero.subtitle': 'Экспертиза в российском и международном B2B. Запускаю и масштабирую продукты на базе GenAI.',
    'hero.primaryCTA': 'Написать в Telegram',
    'hero.secondaryCTA': 'Кейсы',
    
    // About section
    'about.title': 'Обо мне',
    'about.content': 'С 2017 года развиваю продукты и бизнес в образовании и B2B-технологиях. В Skyeng запустил направление работы с корпоративными и госсекторами: вёл крупные сделки и партнёрства с РЖД, Росатом, S7, «Просвещение». Затем соосновал Skipp — вошли в топ-5 стартапов России по версии Inc., привлекли инвестиции от основателей Skyeng и Delivery Club, а также фондов ТилТех Capital и Grishin Robotics. Вывели сервис на международные рынки. Сейчас фокус — внедрение GenAI в компании и образовательные программы. В качестве основателя и эдвайзера запускал проекты в edtech, healthtech и AI.',
    ...
    // Section titles
    'publications.title': 'Публикации и медиа',
